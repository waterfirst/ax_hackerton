...
여러 AI의 중복 작업, 기준본 충돌, 맥락 유실을 막는 AI 협업 지휘소다. Codex CLI와 Claude Code는 각 구독 로그인으로 연결하고, Gemini·DeepSeek·Z.AI는 서버 API 키로 보조 편성한다.
...
- Gemini는 근거 조사, DeepSeek는 기술 반론, Z.AI는 압축 요약을 맡는다.
